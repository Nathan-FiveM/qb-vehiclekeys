...
QBCore.Commands.Add("eng", "Toggle engine On/Off of the vehicle", {}, false, function(source, args)
	TriggerClientEvent('vehiclekeys:client:ToggleEngine', source)
end)

QBCore.Commands.Add("givevkey", "Give keys of the vehicle", {{name = "id", help = "Player id"}}, true, function(source, args)
	local src = source
